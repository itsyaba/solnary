    ...
    <section id="about">
      ...
      <LampContainer>
        ...
        >
          ...
          <br />
          <span className="text-md md:text-2xl font-stinntUltra tracking-wide">
            Solnary plans to grow with you and offer all the services you need to help your company
      ...
      <motion.div
        ...
        className=" flex flex-col items-center justify-center gap-4 -mt-28"
      >
